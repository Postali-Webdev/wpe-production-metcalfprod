 ...
 */
	...
	// Remove stupid crap tyler did... I hope he finds this
	remove_filter('widget_title', 'widget_title_as_class');
	// Add widget title as a class to the widget
	function widget_title_as_class_new($title) { 
	    return '<h4 class="widget-title ' . sanitize_title($title) . '">' . $title . '</h4>';
	}
	add_filter('widget_title', 'widget_title_as_class_new');
