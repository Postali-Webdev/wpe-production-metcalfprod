...
<div id="blog-holder">
    ...
    <section id="blog-banner" class='interior-top-banner'>
    	...
    	<div class="flex">
	    	...
	    	<div class="padd fifty">
	            ...
	            <div class="top-contact-info">
	                <div>
	                    <?php if( !empty( $image ) ): ?>
	                    <div class="round-small"><img src="/wp-content/uploads/2020/01/interior-page-header-attorney-thumbnail.jpg" alt="Attorney Brett Metcalf headshot"/></div>
	                    <?php endif; ?>
	                </div>
	                <span class='contact-phone-email'><span class='gold'>P</span> <a id='header-phone' class='black' href="tel:<?php echo $footerPhone; ?>"><?php echo $footerPhone; ?></a><br><span class='gold'>E</span> <a class='black email-underline header-email' href="mailto:<?php echo $footerEmail; ?>"><?php echo $footerEmail; ?></a></span>
	            </div>
    ...
    <section class="inside-xl blog-posts" id='interior_main-ctn'>
    	...
    	<div class="content">
            ...
            <div class="sidebar thirty" id='interior_sub-ctn'>
